                ...
                <div className="flex items-end justify-between mt-3">
                    ...
                    <div onClick={(e)=> {e.stopPropagation();}} className="text-primary">
                        {!cartItems[product._id] ? (
                            <button className="flex items-center justify-center gap-1 bg-primary/10 border border-primary/50 md:w-[80px] w-[64px] h-[34px] rounded font-medium cursor-pointer" onClick={() => addToCart(product._id)} >
                                <img className='w-4' src={assets.shopping_cart } alt="" />
                                Add
                            </button>
                        ) : (
