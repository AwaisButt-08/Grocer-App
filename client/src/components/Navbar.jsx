    ...
    <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all">
      ...
      <div className="hidden sm:flex items-center gap-8">
        ...
        <div className="hidden lg:flex items-center text-sm gap-2 border border-gray-300 px-3 rounded-full">
          ...
          <img src={assets.magnifying_glass} alt="Search" className="w-4 h-4 color-primary" />
        </div>
        ...
        {!user ? (<button onClick={()=> setShowUserLogin(true)} className="cursor-pointer px-8 py-2 bg-primary hover:bg-primary-dull transition text-white rounded-lg">
          Login
        </button>): 
        (
            <div className="relative group">
                <img src={assets.profiles} alt="Profile" className="w-10 " />
                <ul className="hidden group-hover:block absolute top-10 right-0 bg-white shadow rounded-md z-40 border text-center border-gray-200 py-2.5 w-25 text-sm">
